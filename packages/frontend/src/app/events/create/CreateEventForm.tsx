...
const uploadImage = async (
	file: File,
	setImageId: (image_id: number) => void,
) => {
	...
	return (
		...
		>
			...
			<div className="grid grid-cols-5">
				<button
					type="submit"
					className="col-span-4 col-start-2 rounded-md border border-ra_red hover:bg-ra_red hover:text-black"
				>
					Create
				</button>
				{error && (
					<p className="col-span-4 col-start-2 mt-4 text-center text-2xl">
						{error}
					</p>
				)}
			</div>
