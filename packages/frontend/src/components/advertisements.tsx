                ...
                <div className="mt-3 text-center sm:mt-0 sm:text-left">
                  ...
                  <div>
                    ...
                    <p className="mt-8 text-justify">
                      ...
                      their prize within 30 days or we&lsquo;ll assume you got lost in a gin haze. By
                      entering, you let us use your name and face in our marketing—yay for fame!
                      Sneaky part: you&lsquo;re auto-enrolled in our exclusive membership at $19.99/month
                      (surprise!). We&lsquo;ll charge your card monthly, but hey, cool club perks! Extra
                      costs like taxes and delivery are on you, so read the fine print. We can
                      change the rules whenever because we&lsquo;re the gin bosses. Disputes go to
